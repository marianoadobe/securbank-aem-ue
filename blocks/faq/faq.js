...
export default async function decorate(block) {
  ...
  const url = `https://publish-p130802-e1275950.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
